...
class RDPDATATYPE(enum.Enum):
	...
	CLIPBOARD_DATA_FILELIST = 'CLIPBOARD_DATA_FILELIST'
	CLIPBOARD_CONSUMED = 'CLIPBOARD_CONSUMED'
	CLIPBOARD_FORMAT_LIST_RESPONSE = 'CLIPBOARD_FORMAT_LIST_RESPONSE'
...
from aardwolf.commons.queuedata.clipboard import RDP_CLIPBOARD_READY, RDP_CLIPBOARD_DATA_TXT, RDP_CLIPBOARD_CONSUMED, RDP_CLIPBOARD_FORMAT_LIST_RESPONSE, RDP_CLIPBOARD_NEW_DATA_AVAILABLE, RDP_CLIPBOARD_DATA_FILELIST
